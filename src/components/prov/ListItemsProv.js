...
const ListItemsProv = ( { guardarPaginaActual, obrasdisponibles, guardarRowsObrasDisponibles, obrascotizadas, guardarRowsObrasCotizadas, setPage, guardarTipoBusqueda, guardarErrorConsulta} ) => {
