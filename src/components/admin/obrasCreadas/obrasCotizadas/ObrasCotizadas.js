...
const ObrasCotizadas = ( { datosgenerales, guardarDatosGenerales, titulo, siguientecomponente, cantidadcards, totalpaginas, guardarObra, rows, guardarRows, obrastotal, obrascotizadas, bandObrasCotizadas, tipobusqueda, guardarTipoBusqueda, seleccionpor } ) => {
